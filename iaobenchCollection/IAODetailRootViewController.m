...
#import "IAODetailRootViewController.h"
#import "IAOOfflineViewController.h"
#import "IAOMasterViewController.h"

@interface IAODetailRootViewController ()
@property (strong, nonatomic) UIPopoverController *masterPopoverController;
@end

@implementation IAODetailRootViewController
...
{
    barButtonItem.title = @"List"; //NSLocalizedString(@"Master", @"Master");
...
{
	id aorenderer = [sender selectedRenderer];
