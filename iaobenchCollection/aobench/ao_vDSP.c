// make: llvm-gcc -o ao_vDSP -O3 ao_vDSP.c -lm -framework Accelerate
//  -mfpmath=sse -msse2 
...
{
    vDSP_vaddD(v0.co, 1, v1.co, 1, c->co, 1, 3);
/*
    c->x = v0.x + v1.x;
    c->y = v0.y + v1.y;
    c->z = v0.z + v1.z;
...
{
    vDSP_vsubD(v1.co, 1, v0.co, 1, c->co, 1, 3); //B-A
/*
    c->x = v0.x - v1.x;
    c->y = v0.y - v1.y;
    c->z = v0.z - v1.z;
...
{
    vDSP_vsmaD(v0.co, 1, &n, v1.co, 1, c->co, 1, 3);
/*
    c->x = v0.x * n + v1.x;
    c->y = v0.y * n + v1.y;
    c->z = v0.z * n + v1.z;
...
{
    double r;
    vDSP_dotprD(v0.co, 1, v1.co, 1, &r, 3);
    return r;
