// make: llvm-gcc -o ao_f_vDSP -O3 ao_f_vDSP.c -lm -framework Accelerate
//  -mfpmath=sse -msse2 
...
{
    vDSP_vadd(v0.co, 1, v1.co, 1, c->co, 1, 3);
/*
    c->x = v0.x + v1.x;
    c->y = v0.y + v1.y;
    c->z = v0.z + v1.z;
...
{
    vDSP_vsub(v1.co, 1, v0.co, 1, c->co, 1, 3); //B-A
/*
    c->x = v0.x - v1.x;
    c->y = v0.y - v1.y;
    c->z = v0.z - v1.z;
...
{
    float r;
    vDSP_dotpr(v0.co, 1, v1.co, 1, &r, 3);
    return r;
